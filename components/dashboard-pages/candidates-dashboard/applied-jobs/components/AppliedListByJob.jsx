  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setApplications(allApps.filter(app => app.job.jobId === Number(jobId)));
        setError("");
      } catch (err) {
                ...
                <div className="tabs-box">
                  ...
                  <div className="widget-content">
                    {loading ? (
                      ...
                      <div>You haven't applied for this job yet.</div>
                    ) : (
                      <div className="table-outer">
                        <table className="default-table manage-job-table">
                          <thead>
                            ...
                            {paginatedApplications.map(app => (
                              <tr key={app.applicationId}>
                                <td>
                                  ...
                                  {app.coverLetter && app.coverLetter.length > 100 && (
                                    <button
                                      style={{
                                        marginLeft: 8,
                                        background: 'none',
                                      ...
                                      onClick={() => handleShowModal(app.coverLetter)}
                                    >
                                      Xem thêm
                                    </button>
                                  )}
